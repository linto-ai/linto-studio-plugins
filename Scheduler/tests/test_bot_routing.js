...
describe('BrokerClient bot routing (BotService)', () => {
  ...
  describe('#registerBotService()/#unregisterBotService()', () => {
    ...
    it('removes the replica and drops its ownership entries', async () => {
      ...
      try {
        ...
        instance.unregisterBotService({ uniqueId: 'bs1' });
  ...
  describe('#startBot()', () => {
    ...
    it('routes startbot to the selected BotService with a websocketUrl and records ownership', async () => {
