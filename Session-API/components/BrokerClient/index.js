...
class BrokerClient extends Component {
   ...
   * @param {boolean} botAsync - The file generated by the bot must be saved as WAV
   * @param {object} botLive - Live parameters
   */
  async scheduleStartBot(sessionId, channelId, address, botType, botAsync, botLive) {
    // get the session
    ...
    this.client.publish('scheduler/in/schedule/startbot', { session, channelId, address, botType, botAsync, botLive }, 1, false, true);
  }
