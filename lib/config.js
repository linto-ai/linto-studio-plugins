...
function configureDefaults() {
    try {
        ...
        // Security
        process.env.SECURITY_CRYPT_KEY = ifHas(process.env.SECURITY_CRYPT_KEY, envdefault.SECURITY_CRYPT_KEY);
        process.env.SECURITY_SALT_FILEPATH = ifHas(process.env.SECURITY_SALT_FILEPATH, envdefault.SECURITY_SALT_FILEPATH);
        ...
        process.env.BOTSERVICE_COMPONENTS = ifHas(process.env.BOTSERVICE_COMPONENTS, envdefault.BOTSERVICE_COMPONENTS); // you might not want to change this
        process.env.BOTSERVICE_HEALTHCHECK_HTTP = ifHas(process.env.BOTSERVICE_HEALTHCHECK_HTTP, envdefault.BOTSERVICE_HEALTHCHECK_HTTP);
        ...
        if (process.env.STREAMING_PASSPHRASE && process.env.STREAMING_PASSPHRASE !== 'false' && process.env.STREAMING_PASSPHRASE.length < 10) {
            ...
            logger.error('Passphrase must be at least 10 characters long. Disabling passphrase.');
        }
        ...
        process.env.STREAMING_PROXY_SRT_HOST = ifHas(process.env.STREAMING_PROXY_SRT_HOST, envdefault.STREAMING_PROXY_SRT_HOST);
        ...
        process.env.STREAMING_PROXY_RTMP_HOST = ifHas(process.env.STREAMING_PROXY_RTMP_HOST, envdefault.STREAMING_PROXY_RTMP_HOST);
        ...
        process.env.STREAMING_PROXY_WS_HOST = ifHas(process.env.STREAMING_PROXY_WS_HOST, envdefault.STREAMING_PROXY_WS_HOST);
        ...
        process.env.STREAMING_WS_SECURE = ifHas(process.env.STREAMING_WS_SECURE, envdefault.STREAMING_WS_SECURE);
        process.env.STREAMING_WS_ENDPOINT = ifHas(process.env.STREAMING_WS_ENDPOINT, envdefault.STREAMING_WS_ENDPOINT);
        process.env.STREAMING_RTMP_SECURE = ifHas(process.env.STREAMING_RTMP_SECURE, envdefault.STREAMING_RTMP_SECURE);
