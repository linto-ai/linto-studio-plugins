...
function configureDefaults() {
    try {
        ...
        process.env.SCHEDULER_WEBSERVER_HTTP_PORT = ifHas(process.env.SCHEDULER_WEBSERVER_HTTP_PORT, envdefault.SCHEDULER_WEBSERVER_HTTP_PORT)
        process.env.SESSION_SCHEDULER_URL = ifHas(process.env.SESSION_SCHEDULER_URL, envdefault.SESSION_SCHEDULER_URL)
        ...
        process.env.DELIVERY_WEBSERVER_HTTP_PORT = ifHas(process.env.DELIVERY_WEBSERVER_HTTP_PORT, envdefault.DELIVERY_WEBSERVER_HTTP_PORT)
        ...
        process.env.SESSION_API_PUBLIC_URL = ifHas(process.env.SESSION_API_PUBLIC_URL, envdefault.SESSION_API_PUBLIC_URL)
        //TRANSCRIBER ASR
        process.env.ASR_PROVIDER = ifHas(process.env.ASR_PROVIDER, envdefault.ASR_PROVIDER)
        process.env.ASR_LANGUAGE = ifHas(process.env.ASR_LANGUAGE, envdefault.ASR_LANGUAGE)
        ...
        //streaming server
        process.env.STREAMING_PROTOCOL = ifHas(process.env.STREAMING_PROTOCOL, envdefault.STREAMING_PROTOCOL)
        ...
        process.env.STREAMING_PROXY_PORT = ifHas(process.env.STREAMING_PROXY_PORT, envdefault.STREAMING_PROXY_PORT)
        ...
        process.env.TCP_RANGE = ifHas(process.env.TCP_RANGE, envdefault.TCP_RANGE)
